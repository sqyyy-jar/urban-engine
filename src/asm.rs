...
/// `b <i26>`
pub const INSN_B_IMMEDIATE: u32 = 0b000110_00000000000000000000000000;
pub const ENDINSN_B_IMMEDIATE: u32 = 0b000110_11111111111111111111111111;
/// `b.eq <X0>, <i21>`
pub const INSN_B_EQ_IMMEDIATE: u32 = 0b000111_000000000000000000000_00000;
pub const ENDINSN_B_EQ_IMMEDIATE: u32 = 0b000111_111111111111111111111_11111;
/// `b.ge <X0>, <i21>`
pub const INSN_B_GE_IMMEDIATE: u32 = 0b001000_000000000000000000000_00000;
pub const ENDINSN_B_GE_IMMEDIATE: u32 = 0b001000_111111111111111111111_11111;
/// `b.gt <X0>, <i21>`
pub const INSN_B_GT_IMMEDIATE: u32 = 0b001001_000000000000000000000_00000;
pub const ENDINSN_B_GT_IMMEDIATE: u32 = 0b001001_111111111111111111111_11111;
/// `b.le <X0>, <i21>`
pub const INSN_B_LE_IMMEDIATE: u32 = 0b001010_000000000000000000000_00000;
pub const ENDINSN_B_LE_IMMEDIATE: u32 = 0b001010_111111111111111111111_11111;
/// `b.lt <X0>, <i21>`
pub const INSN_B_LT_IMMEDIATE: u32 = 0b001011_000000000000000000000_00000;
pub const ENDINSN_B_LT_IMMEDIATE: u32 = 0b001011_111111111111111111111_11111;
/// `b.ne <X0>, <i21>`
pub const INSN_B_NE_IMMEDIATE: u32 = 0b001100_000000000000000000000_00000;
pub const ENDINSN_B_NE_IMMEDIATE: u32 = 0b001100_111111111111111111111_11111;
/// `bl <i26>`
...
/// `shl <X0>, <X1>, <i16>`
pub const INSN_SHL_IMMEDIATE: u32 = 0b100100_0000000000000000_00000_00000;
pub const ENDINSN_SHL_IMMEDIATE: u32 = 0b100100_1111111111111111_11111_11111;
/// `shr <X0>, <X1>, <i16>`
pub const INSN_SHR_IMMEDIATE: u32 = 0b100101_0000000000000000_00000_00000;
pub const ENDINSN_SHR_IMMEDIATE: u32 = 0b100101_1111111111111111_11111_11111;
/// `shrs <X0>, <X1>, <i16>`
pub const INSN_SHRS_IMMEDIATE: u32 = 0b100110_0000000000000000_00000_00000;
pub const ENDINSN_SHRS_IMMEDIATE: u32 = 0b100110_1111111111111111_11111_11111;
/// `str <X0>, <X1>`
