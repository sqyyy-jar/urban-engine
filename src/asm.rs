...
/// ldr <X0>, <X1>
pub const INSN_LDR: u32 = 0b010110_0000000000000000_00000_00000;
pub const ENDINSN_LDR: u32 = 0b010110_1111111111111111_11111_11111;
/// ldr <X0>, <i21>
pub const INSN_LDR_IMMEDIATE: u32 = 0b010111_000000000000000000000_00000;
pub const ENDINSN_LDR_IMMEDIATE: u32 = 0b010111_111111111111111111111_11111;
/// mov <X0>, <X1>
pub const INSN_MOV: u32 = 0b011000_0000000000000000_00000_00000;
pub const ENDINSN_MOV: u32 = 0b011000_1111111111111111_11111_11111;
/// mov <X0>, <i21>
pub const INSN_MOV_IMMEDIATE: u32 = 0b011001_000000000000000000000_00000;
pub const ENDINSN_MOV_IMMEDIATE: u32 = 0b011001_111111111111111111111_11111;
/// movs <X0>, <i21>
pub const INSN_MOVS_IMMEDIATE: u32 = 0b011010_000000000000000000000_00000;
pub const ENDINSN_MOVS_IMMEDIATE: u32 = 0b011010_111111111111111111111_11111;
/// mul <X0>, <X1>, <X2>
pub const INSN_MUL: u32 = 0b011011_00000000000_00000_00000_00000;
pub const ENDINSN_MUL: u32 = 0b011011_11111111111_11111_11111_11111;
/// mul <X0>, <X1>, <i16>
pub const INSN_MUL_IMMEDIATE: u32 = 0b011100_0000000000000000_00000_00000;
pub const ENDINSN_MUL_IMMEDIATE: u32 = 0b011100_1111111111111111_11111_11111;
/// mulf <X0>, <X1>, <X2>
pub const INSN_MULF: u32 = 0b011101_00000000000_00000_00000_00000;
pub const ENDINSN_MULF: u32 = 0b011101_11111111111_11111_11111_11111;
/// muls <X0>, <X1>, <X2>
pub const INSN_MULS: u32 = 0b011110_00000000000_00000_00000_00000;
pub const ENDINSN_MULS: u32 = 0b011110_11111111111_11111_11111_11111;
/// muls <X0>, <X1>, <i16>
pub const INSN_MULS_IMMEDIATE: u32 = 0b011111_0000000000000000_00000_00000;
pub const ENDINSN_MULS_IMMEDIATE: u32 = 0b011111_1111111111111111_11111_11111;
/// nop
pub const INSN_NOP: u32 = 0b100000_00000000000000000000000000;
pub const ENDINSN_NOP: u32 = 0b100000_11111111111111111111111111;
/// not <X0>, <X1>
pub const INSN_NOT: u32 = 0b100001_0000000000000000_00000_00000;
pub const ENDINSN_NOT: u32 = 0b100001_1111111111111111_11111_11111;
/// or <X0>, <X1>, <X2>
pub const INSN_OR: u32 = 0b100010_00000000000_00000_00000_00000;
pub const ENDINSN_OR: u32 = 0b100010_11111111111_11111_11111_11111;
/// shl <X0>, <X1>, <i16>
pub const INSN_SHL: u32 = 0b100011_0000000000000000_00000_00000;
pub const ENDINSN_SHL: u32 = 0b100011_1111111111111111_11111_11111;
/// shr <X0>, <X1>, <i16>
pub const INSN_SHR: u32 = 0b100100_0000000000000000_00000_00000;
pub const ENDINSN_SHR: u32 = 0b100100_1111111111111111_11111_11111;
/// shrs <X0>, <X1>, <i16>
pub const INSN_SHRS: u32 = 0b100101_0000000000000000_00000_00000;
pub const ENDINSN_SHRS: u32 = 0b100101_1111111111111111_11111_11111;
/// sub <X0>, <X1>, <X2>
pub const INSN_SUB: u32 = 0b100110_00000000000_00000_00000_00000;
pub const ENDINSN_SUB: u32 = 0b100110_11111111111_11111_11111_11111;
/// sub <X0>, <X1>, <i16>
pub const INSN_SUB_IMMEDIATE: u32 = 0b100111_0000000000000000_00000_00000;
pub const ENDINSN_SUB_IMMEDIATE: u32 = 0b100111_1111111111111111_11111_11111;
/// subf <X0>, <X1>, <X2>
pub const INSN_SUBF: u32 = 0b101000_00000000000_00000_00000_00000;
pub const ENDINSN_SUBF: u32 = 0b101000_11111111111_11111_11111_11111;
/// subs <X0>, <X1>, <X2>
pub const INSN_SUBS: u32 = 0b101001_00000000000_00000_00000_00000;
pub const ENDINSN_SUBS: u32 = 0b101001_11111111111_11111_11111_11111;
/// subs <X0>, <X1>, <i16>
pub const INSN_SUBS_IMMEDIATE: u32 = 0b101010_0000000000000000_00000_00000;
pub const ENDINSN_SUBS_IMMEDIATE: u32 = 0b101010_1111111111111111_11111_11111;
/// syscall <i26>
pub const INSN_SYSCALL_IMMEDIATE: u32 = 0b101011_00000000000000000000000000;
pub const ENDINSN_SYSCALL_IMMEDIATE: u32 = 0b101011_11111111111111111111111111;
/// xor <X0>, <X1>, <X2>
pub const INSN_XOR: u32 = 0b101100_00000000000_00000_00000_00000;
pub const ENDINSN_XOR: u32 = 0b101100_11111111111_11111_11111_11111;
